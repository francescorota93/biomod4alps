...
Rscript $HOME/data/biomod4alps/launch_build_model.R --cores 15 --workdir $HOME/data/ --scriptdir $HOME/data/biomod4alps
--species 1 2 5 6 7 8 --models GLM GAM GBM RF CTA
