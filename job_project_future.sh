...
Rscript $HOME/data/biomod4alps/launch_project_future.R -c 25  -w $HOME/data/ --scriptdir $HOME/data/biomod4alps -s 6 7 8  --models  RF GLM GBM  --temprastdir $GLOBAL/temp_rast_dir       
