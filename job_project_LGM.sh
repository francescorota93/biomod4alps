...
Rscript $HOME/data/biomod4alps/launch_project_LGM.R -c 20  -w $HOME/data/ --scriptdir $HOME/data/biomod4alps -s 1 5 6 7 --models GLM GBM RF GAM CTA  --temprastdir $HOME/temp_rast_dir       
