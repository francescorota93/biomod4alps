...
Rscript $HOME/data/biomod4alps/launch_project_current.R --cores 25  --workdir $HOME/data/ --scriptdir $HOME/data/biomod4alps -s 1 2 3 4 5 6 7 8 --models GLM GAM GBM RF CTA --outdir /models_topography --projection_name topo
